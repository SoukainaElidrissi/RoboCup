...
public class Simulation extends Canvas implements Runnable {
    ...
    public void initialize(AgentContainer agentContainer) throws StaleProxyException {
        ...
        joueurs.add(agentContainer.createNewAgent("Hakim Ziyech",
                AgentJoueur.class.getName(), argsJoueur1));
        joueurs.add(agentContainer.createNewAgent("Nayef",
                AgentJoueur.class.getName(), argsJoueur2));
        joueurs.add(agentContainer.createNewAgent("Achraf Hakimi",
                AgentJoueur.class.getName(), argsJoueur3));
        joueurs.add(agentContainer.createNewAgent("Ounahi",
        ...
        if (ReglesDuJeu.NBJOUEURS >= 5) {
            ...
            joueurs.add(agentContainer.createNewAgent("Neymar",
            ...
            if (ReglesDuJeu.NBJOUEURS >= 6) {
                ...
                joueurs.add(agentContainer.createNewAgent("Vinicius ",
                ...
                if (ReglesDuJeu.NBJOUEURS >= 7) {
                    ...
                    joueurs.add(agentContainer.createNewAgent("Rodrygo",
                    ...
                    if (ReglesDuJeu.NBJOUEURS >= 8) {
                        ...
                        joueurs.add(agentContainer.createNewAgent("Messi",
